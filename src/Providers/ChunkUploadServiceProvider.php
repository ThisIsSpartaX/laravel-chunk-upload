<?php
namespace Ruslone\Laravel\ChunkUpload\Providers;

use Illuminate\Console\Scheduling\Schedule;
use Illuminate\Foundation\Application;
use Illuminate\Support\Arr;
use Illuminate\Support\ServiceProvider;
use Ruslone\Laravel\ChunkUpload\Commands\ClearChunksCommand;
use Ruslone\Laravel\ChunkUpload\Config\AbstractConfig;
use Ruslone\Laravel\ChunkUpload\Config\FileConfig;
